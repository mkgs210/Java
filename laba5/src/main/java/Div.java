...
public class Div extends CalcOperation{
    Div(String[] args, LinkedList<Double> stack, HashMap<String, Double> def, Integer line) {
        super(args, stack, def, line);
    }
    Div(String[] args, LinkedList<Double> stack, HashMap<String, Double> def) {
